...
CREATE OR REPLACE TABLE technology
  ( 
    SID bigint
    ...
    ,Name STRING
      COMMENT 'Display Name of the Technology'
    ,Technology_Group_Code STRING
      COMMENT 'Key for the Technology Group'
    ,SortOrder INT
      COMMENT 'TODO'
  ...
  ,CONSTRAINT technology_pk PRIMARY KEY(Code, Sys_DatabaseName)
  )
COMMENT 'This table contains the data for technology categories.' 
TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
CLUSTER BY (Code,Sys_DatabaseName)

-- COMMAND ----------

ALTER TABLE technology ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE technology ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE technology ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
