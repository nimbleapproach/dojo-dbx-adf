...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE inventtrans
# MAGIC   ( 
# MAGIC     SID bigint
...
# MAGIC    ,ItemId STRING
# MAGIC       COMMENT 'TODO'
# MAGIC    ,CostAmountAdjustment DECIMAL(18,2)
# MAGIC       COMMENT 'TODO'
# MAGIC    ,CostAmountPosted DECIMAL(18,2)
# MAGIC       COMMENT 'TODO'
# MAGIC    ,CurrencyCode STRING
# MAGIC       COMMENT 'TODO'
# MAGIC    ,DateClosed DATE
# MAGIC       COMMENT 'TODO'
# MAGIC    ,DateExpected DATE
# MAGIC       COMMENT 'TODO'
# MAGIC    ,DataAreaId STRING
# MAGIC       COMMENT 'TODO' 
# MAGIC     ,MODIFIEDDATETIME DATE
# MAGIC       COMMENT 'TODO'
...
# MAGIC %sql
# MAGIC
# MAGIC ALTER TABLE inventtrans ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE inventtrans ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE inventtrans ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
