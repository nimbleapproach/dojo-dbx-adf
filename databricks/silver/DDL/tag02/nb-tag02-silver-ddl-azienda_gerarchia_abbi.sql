...
CREATE OR REPLACE TABLE azienda_gerarchia_abbi
  ( SID bigint
    GENERATED ALWAYS AS IDENTITY
    ,COD_AZIENDA STRING NOT NULL 
      COMMENT 'Entity Code'
    ,COD_AZIENDA_GERARCHIA STRING

    ,COD_AZIENDA_ELEGER STRING
...
,CONSTRAINT azienda_gerarchia_abbi_pk PRIMARY KEY(COD_AZIENDA,COD_AZIENDA_GERARCHIA,ORDINAMENTO, DATEUPD)
  )

TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
CLUSTER BY (COD_AZIENDA,COD_AZIENDA_GERARCHIA,ORDINAMENTO)

-- COMMAND ----------

ALTER TABLE azienda_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE azienda_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE azienda_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
