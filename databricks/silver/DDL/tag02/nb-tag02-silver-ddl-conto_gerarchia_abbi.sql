...
CREATE OR REPLACE TABLE conto_gerarchia_abbi
  ( SID bigint
...
,CONSTRAINT conto_gerarchia_abbi_pk PRIMARY KEY(COD_CONTO,COD_CONTO_GERARCHIA, DATEUPD)
  )

TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
CLUSTER BY (COD_CONTO,COD_CONTO_GERARCHIA)

-- COMMAND ----------

ALTER TABLE conto_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE conto_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE conto_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
