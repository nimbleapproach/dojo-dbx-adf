...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC CREATE OR REPLACE TABLE dest3_gerarchia_abbi
# MAGIC   ( SID bigint
# MAGIC     GENERATED ALWAYS AS IDENTITY
# MAGIC     ,COD_DEST3 STRING NOT NULL 
# MAGIC       COMMENT 'Entity Code'
# MAGIC     ,COD_DEST3_ELEGER STRING
# MAGIC     ,COD_DEST3_GERARCHIA STRING
...
# MAGIC ,CONSTRAINT dest3_gerarchia_abbi_pk PRIMARY KEY(COD_DEST3,COD_DEST3_ELEGER,COD_DEST3_GERARCHIA,ORDINAMENTO, DATEUPD)
# MAGIC   )
# MAGIC
# MAGIC TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
# MAGIC CLUSTER BY (COD_DEST3,COD_DEST3_ELEGER,COD_DEST3_GERARCHIA,ORDINAMENTO);
# MAGIC
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC ALTER TABLE dest3_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE dest3_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE dest3_gerarchia_abbi ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
# MAGIC
