...
CREATE OR REPLACE TABLE dati_cambio
  ( SID bigint
...
CLUSTER BY (COD_SCENARIO,COD_PERIODO,COD_VALUTA)

-- COMMAND ----------

ALTER TABLE dati_cambio ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dati_cambio ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dati_cambio ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
