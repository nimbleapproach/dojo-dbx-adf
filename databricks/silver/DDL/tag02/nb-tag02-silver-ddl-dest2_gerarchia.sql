...
CREATE OR REPLACE TABLE dest2_gerarchia
  ( SID bigint
    GENERATED ALWAYS AS IDENTITY
    ,COD_DEST2_ELEGER STRING NOT NULL 

    ,COD_DEST2_ELEGER_PADRE STRING NOT NULL 
    ,COD_DEST2_GERARCHIA  STRING NOT NULL 
...
,CONSTRAINT dest2_gerarchia_pk PRIMARY KEY(COD_DEST2_ELEGER,COD_DEST2_ELEGER_PADRE,COD_DEST2_GERARCHIA,ORDINAMENTO, DATEUPD)
  )

TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
CLUSTER BY (COD_DEST2_ELEGER,COD_DEST2_ELEGER_PADRE,COD_DEST2_GERARCHIA,ORDINAMENTO)

-- COMMAND ----------

ALTER TABLE dest2_gerarchia ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dest2_gerarchia ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dest2_gerarchia ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
