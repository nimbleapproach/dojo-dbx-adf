...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC CREATE OR REPLACE TABLE dest3
# MAGIC   ( SID bigint
# MAGIC     GENERATED ALWAYS AS IDENTITY
# MAGIC     ,COD_DEST3 STRING NOT NULL 
# MAGIC       COMMENT 'Cost Centre Code'
# MAGIC     ,DESC_DEST30 STRING NOT NULL 
# MAGIC       COMMENT 'Cost Centre Name'
# MAGIC     ,PROVENIENZA STRING
# MAGIC       COMMENT 'Record provenance'
...
# MAGIC ,CONSTRAINT dest3_pk PRIMARY KEY(COD_DEST3, DATEUPD)
# MAGIC   )
# MAGIC
# MAGIC TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
# MAGIC CLUSTER BY (COD_DEST3);
# MAGIC
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC ALTER TABLE dest3 ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE dest3 ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
# MAGIC ALTER TABLE dest3 ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
# MAGIC
# MAGIC
# MAGIC
# MAGIC
