...
CREATE OR REPLACE TABLE dest2
  ( SID bigint
    GENERATED ALWAYS AS IDENTITY
    ,COD_DEST2 STRING NOT NULL 
      COMMENT 'Region Code'
    ,DESC_DEST20 STRING NOT NULL 
...
,CONSTRAINT dest2_pk PRIMARY KEY(COD_DEST2, DATEUPD)
  )

TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
CLUSTER BY (COD_DEST2)

-- COMMAND ----------

ALTER TABLE dest2 ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dest2 ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dest2 ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
