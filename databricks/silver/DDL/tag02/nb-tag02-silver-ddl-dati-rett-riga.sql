...
CREATE OR REPLACE TABLE dati_rett_riga
  ( SID bigint
    GENERATED ALWAYS AS IDENTITY
    ,OID_DATI_RETT_RIGA STRING
      COMMENT 'OID'
    ,COD_SCENARIO     STRING
...
,CONSTRAINT dati_rett_riga_pk PRIMARY KEY(COD_PERIODO,COD_SCENARIO,OID_DATI_RETT_RIGA,DATE_UPD)
...
ALTER TABLE dati_rett_riga ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Bronze_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dati_rett_riga ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Silver_InsertDateTime_UTC > '1900-01-01');
ALTER TABLE dati_rett_riga ADD CONSTRAINT dateWithinRange_Silver_ModifedDateTime CHECK (Sys_Silver_ModifedDateTime_UTC > '1900-01-01');
