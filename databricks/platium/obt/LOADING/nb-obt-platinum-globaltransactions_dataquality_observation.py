...
SELECT DISTINCT GroupEntityCode, EntityCode, TransactionDate,
--SalesOrderDate
...
SUM(CASE WHEN CommitmentDuration2Master IN ('NaN','DataNowArr data not available') THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS CommitmentDuration2Master_NaN,
...
--VendorCode
SUM(CASE WHEN VendorCode IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS VendorCode_Null,
...
--VendorNameInternal
SUM(CASE WHEN VendorNameInternal IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS VendorNameInternal_Null,
...
--VendorNameMaster
SUM(CASE WHEN VendorNameMaster IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS VendorNameMaster_Null,
...
--VendorGeography
SUM(CASE WHEN VendorGeography IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS VendorGeography_Null,
...
--VendorStartDate
SUM(CASE WHEN VendorStartDate IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS VendorStartDate_Null,
...
--ResellerCode
SUM(CASE WHEN ResellerCode IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerCode_Null,
...
SUM(CASE WHEN ResellerNameInternal IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerNameInternal_Null,
...
SUM(CASE WHEN ResellerGeographyInternal IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerGeographyInternal_Null,
...
--ResellerStartDate
SUM(CASE WHEN ResellerStartDate IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerStartDate_Null,
...
--ResellerGroupCode
SUM(CASE WHEN ResellerGroupCode IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerGroupCode_Null,
...
SUM(CASE WHEN ResellerGroupStartDate IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS ResellerGroupStartDate_Null,
...
--CurrencyCode
SUM(CASE WHEN CurrencyCode IS NULL THEN 1 ELSE 0 END) OVER (PARTITION BY GroupEntityCode, EntityCode, TransactionDate) AS CurrencyCode_Null,
