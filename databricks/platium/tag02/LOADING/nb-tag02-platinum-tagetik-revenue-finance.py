...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE VIEW tagetik_revenue_finance AS
# MAGIC
# MAGIC SELECT y.date,
# MAGIC        y.period,
# MAGIC        y.currency_code,
# MAGIC        y.region_name,
# MAGIC        y.country_code,
# MAGIC        y.vendor_name AS vendor,
# MAGIC        y.entity_description,
...
# MAGIC        x.region_name,
# MAGIC        x.country_code,
# MAGIC        x.vendor_name,
# MAGIC        x.cost_centre_code,
# MAGIC        x.scenario_code,
# MAGIC        x.entity_description,
# MAGIC        x.category,
# MAGIC        x.revenue,
# MAGIC        LAG (x.revenue) OVER (PARTITION BY x.currency_code, x.account_code, x.special_deal_code, x.region_name, x.vendor_name, x.cost_centre_code, x.scenario_code, x.entity_description, x.category ORDER BY x.date_id, x.period ) AS next_revenue,
...
# MAGIC        dr.region_name,
# MAGIC        COALESCE(dr.country_code,'') AS country_code,
# MAGIC        dv.vendor_name,
# MAGIC        dcc.cost_centre_code,
# MAGIC        ds.scenario_code,
# MAGIC        de.entity_description,
# MAGIC        ftr.category,
...
# MAGIC        ftr.special_deal_code,
# MAGIC        dr.region_name,
# MAGIC        COALESCE(dr.country_code,''),
# MAGIC        dv.vendor_name,
# MAGIC        dcc.cost_centre_code,
# MAGIC        ds.scenario_code,
# MAGIC        de.entity_description,
