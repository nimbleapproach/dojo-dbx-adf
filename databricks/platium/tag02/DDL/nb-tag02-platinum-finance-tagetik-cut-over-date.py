...
# MAGIC LEFT OUTER JOIN (SELECT CAST('2024-10-01' AS DATE) AS date
# MAGIC                  UNION ALL
# MAGIC                  SELECT CAST('2024-12-01' AS DATE)) b -- This table should contain dates for all overridden months, use the 1st of the in the comparison to NOW() to ensure current date is after it I.E. it's been overridden and use the end of the previous month as the Tagetik cut over 
