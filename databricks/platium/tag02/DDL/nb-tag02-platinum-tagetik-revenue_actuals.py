...
# MAGIC       (CASE WHEN atyp.total_revenue = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_lcy 
# MAGIC             WHEN atyp.total_revenue = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_lcy ELSE 0 END) AS total_revenue_in_lcy,
# MAGIC       (CASE WHEN atyp.total_revenue = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_euros 
# MAGIC             WHEN atyp.total_revenue = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_euros ELSE 0 END) AS total_revenue_in_euros,
# MAGIC       (CASE WHEN atyp.total_cogs = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_lcy 
# MAGIC             WHEN atyp.total_cogs = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_lcy ELSE 0 END) AS total_cogs_in_lcy,
# MAGIC       (CASE WHEN atyp.total_cogs = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_euros 
# MAGIC             WHEN atyp.total_cogs = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_euros ELSE 0 END) AS total_cogs_in_euros,
# MAGIC       (CASE WHEN atyp.gp1 = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_lcy 
# MAGIC             WHEN atyp.gp1 = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_lcy  ELSE 0 END) AS total_gp1_in_lcy,
# MAGIC       (CASE WHEN atyp.gp1 = 1 AND y.category <> 'GP_ALLOC' THEN monthly_revenue_in_euros 
# MAGIC             WHEN atyp.gp1 = 1 AND y.category LIKE 'IFCSYN%' AND entity_code = 'UK2' THEN monthly_revenue_in_euros ELSE 0 END) AS total_gp1_in_euros
# MAGIC FROM
# MAGIC (
