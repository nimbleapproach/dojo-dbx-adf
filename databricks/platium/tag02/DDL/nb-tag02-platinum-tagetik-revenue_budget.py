...
# MAGIC       (CASE WHEN account_code in (309988) THEN monthly_revenue_in_lcy ELSE 0 END) AS total_revenue_in_lcy,
# MAGIC       (CASE WHEN account_code in (309988) THEN monthly_revenue_in_euros ELSE 0 END) AS total_revenue_in_euros,
