...
# MAGIC        CAST(drr.Sys_Silver_ModifedDateTime_UTC AS TIMESTAMP) AS source_date_updated,
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TEMPORARY VIEW vw_fact_tagetik_revenue_drr_to_load_altered_keys AS
# MAGIC
...
# MAGIC FROM vw_fact_tagetik_revenue_drr_to_load_altered_keys
# MAGIC """)
# MAGIC
