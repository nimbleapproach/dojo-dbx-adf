...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC CREATE OR REPLACE TABLE account_type
...
# MAGIC ,CONSTRAINT account_type PRIMARY KEY(account_code)
# MAGIC   )
# MAGIC
...
# MAGIC INSERT INTO gold_{ENVIRONMENT}.tag02.account_type (account_code, total_revenue, total_cogs, gp1)
