...
# MAGIC Created BY [YZ]\
# MAGIC Generate a flattened Chart of accounts hierarchy from three tagetik objects. 
# MAGIC
# MAGIC NOTE: this script was copied from adminksa repo and changed to write to tag02 instead of obt.
