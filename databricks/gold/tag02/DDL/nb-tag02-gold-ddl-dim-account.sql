...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC CREATE OR REPLACE TABLE dim_account
# MAGIC   ( dim_account_pk bigint
# MAGIC     GENERATED BY DEFAULT AS IDENTITY
# MAGIC     ,account_code STRING NOT NULL 
...
# MAGIC ,CONSTRAINT dim_account_primary_key PRIMARY KEY(dim_account_pk)
# MAGIC   )
# MAGIC
...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC ALTER TABLE dim_account ADD CONSTRAINT dateWithinRange_start_datetime CHECK (start_datetime >= '1900-01-01');
# MAGIC ALTER TABLE dim_account ADD CONSTRAINT valid_is_current_value CHECK (is_current IN (1, 0));
# MAGIC
