...
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC CREATE OR REPLACE TABLE dim_vendor
# MAGIC   ( dim_vendor_pk bigint
# MAGIC     GENERATED BY DEFAULT AS IDENTITY
# MAGIC     ,vendor_code STRING NOT NULL 
# MAGIC       COMMENT 'Vendor Code'
# MAGIC     ,vendor_name STRING
# MAGIC       COMMENT 'The description name of the vendor'
# MAGIC     ,vendor_hash_key STRING
# MAGIC       COMMENT 'Hash value of the dimensional attributes per vendor code'
...
# MAGIC ,CONSTRAINT dim_vendor_primary_key PRIMARY KEY(dim_vendor_pk)
# MAGIC   )
# MAGIC
# MAGIC TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported')
# MAGIC CLUSTER BY (vendor_code);
# MAGIC
# MAGIC -- COMMAND ----------
# MAGIC
# MAGIC ALTER TABLE dim_vendor ADD CONSTRAINT dateWithinRange_start_datetime CHECK (start_datetime >= '1900-01-01');
# MAGIC ALTER TABLE dim_vendor ADD CONSTRAINT valid_is_current_value CHECK (is_current IN (1, 0));
# MAGIC
...
# MAGIC SELECT CAST(-1 AS BIGINT) AS dim_vendor_pk,
# MAGIC        CAST('N/A' AS STRING) AS vendor_code,
# MAGIC        CAST(NULL AS STRING) AS vendor_name,
# MAGIC        CAST(NULL AS STRING) AS vendor_hash_key,
