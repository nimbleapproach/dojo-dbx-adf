...
-- COMMAND ----------
CREATE OR REPLACE TABLE dim_entity_to_entity_group_link 
 (
  entity_to_entity_group_link_pk BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
  entity_group_pk BIGINT NOT NULL COMMENT 'Entity Group PK from the Dimension table',
  entity_pk BIGINT NOT NULL COMMENT 'Entity PK from the Dimension table',
  ...
  CONSTRAINT `dim_entity_to_entity_group_link_primary_key` PRIMARY KEY (`entity_to_entity_group_link_pk`))
USING delta
...
ALTER TABLE dim_entity_to_entity_group_link ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Gold_InsertDateTime_UTC >= '1900-01-01');
ALTER TABLE dim_entity_to_entity_group_link ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Gold_ModifedDateTime_UTC >= '1900-01-01');
