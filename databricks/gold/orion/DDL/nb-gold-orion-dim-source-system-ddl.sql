...
-- COMMAND ----------
CREATE OR REPLACE TABLE source_system
(
  ...
  databricks_source_database STRING COMMENT 'The source database of data on databricks',
  external_source_database STRING COMMENT 'The reporting source database name from external, e.g. ReportDE, ReportsFR, etc',
