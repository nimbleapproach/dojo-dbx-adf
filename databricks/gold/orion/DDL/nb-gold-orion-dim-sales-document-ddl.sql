...
-- MAGIC # dim_slaes_document default member
-- MAGIC sqldf= spark.sql("""
-- MAGIC SELECT CAST(-1 AS BIGINT) AS sales_document_pk,
-- MAGIC        CAST('N/A' AS STRING) AS document_id,
-- MAGIC        CAST('1900-01-01' AS DATE) AS document_date,
-- MAGIC        CAST(-1 AS BIGINT) AS document_type,
...
-- MAGIC """).write.mode("append").option("mergeSchema", "true").saveAsTable("dim_sales_document")
