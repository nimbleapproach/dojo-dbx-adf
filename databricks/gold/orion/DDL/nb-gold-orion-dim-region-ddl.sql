CREATE OR REPLACE TABLE dim_region 
 (
  region_pk bigint GENERATED BY DEFAULT AS IDENTITY,
  ...
  region_group STRING COMMENT 'The high level region grouping' ,     
...
CONSTRAINT `dim_region_primary_key` PRIMARY KEY (`region_pk`))
USING delta
