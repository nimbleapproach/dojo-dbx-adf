...
-- COMMAND ----------
CREATE OR REPLACE TABLE dim_vendor_to_vendor_master_link 
 (
  vendor_to_vendor_master_pk BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
  vendor_master_pk BIGINT NOT NULL COMMENT 'Vendor Master pk from the Dimension Table',
  vendor_pk BIGINT NOT NULL COMMENT 'The Vendor pk from the Dimension Table',
  ...
  CONSTRAINT `dim_vendor_to_vendor_master_primary_key` PRIMARY KEY (`vendor_to_vendor_master_pk`))
USING delta
...
ALTER TABLE dim_vendor_to_vendor_master_link ADD CONSTRAINT dateWithinRange_Bronze_InsertDateTime CHECK (Sys_Gold_InsertDateTime_UTC >= '1900-01-01');
ALTER TABLE dim_vendor_to_vendor_master_link ADD CONSTRAINT dateWithinRange_Silver_InsertDateTime CHECK (Sys_Gold_ModifedDateTime_UTC >= '1900-01-01');
