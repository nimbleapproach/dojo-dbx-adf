...
-- MAGIC # dim_reseller_group default member
-- MAGIC sqldf= spark.sql("""
-- MAGIC SELECT CAST(-1 AS BIGINT) AS reseller_group_pk,
-- MAGIC        CAST('N/A' AS STRING) AS reseller_group_code,
-- MAGIC        CAST(NULL AS STRING) AS reseller_group_name_internal,
-- MAGIC        CAST('1900-01-01' AS TIMESTAMP) AS reseller_group_start_date,
...
-- MAGIC """).write.mode("append").option("mergeSchema", "true").saveAsTable("dim_reseller_group")
