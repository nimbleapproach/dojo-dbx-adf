...
dbutils.fs.ls(f'mnt/bronze/{ROOT_PATH}')
...
registerTable(rootPath = 'nuvias_d365', tableName = 'GeneralJournalEntryBiEntities', schemaName=BRONZE_SCHEMA, recreate=REREGISTER, tableFormat=TABLE_FORMAT)
