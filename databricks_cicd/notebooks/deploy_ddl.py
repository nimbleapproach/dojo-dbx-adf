...
def set_global_parameters():
    ...
    azure_client_id = get_param('azure_client_id', '6aa62720-1b89-4152-bfde-fa64831799ef') # default to SP used in ANWO
    secret_scope = get_param('secret_scope','kv-ig-dev-westeurope')
