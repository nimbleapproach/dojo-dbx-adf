...
CREATE TABLE IF NOT EXISTS {catalog}.{schema}.link_vendor_to_vendor_master (
  vendor_to_vendor_master_pk BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
  vendor_master_fk BIGINT NOT NULL COMMENT 'Vendor Master pk from the Dimension Table',
...
USING delta
CLUSTER BY (vendor_master_fk, vendor_fk,parent_vendor_fk)
TBLPROPERTIES (
