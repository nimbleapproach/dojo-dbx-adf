...
spark.sql(f"""
CREATE TABLE IF NOT EXISTS {catalog}.{schema}.dim_datasets (
  DatasetId STRING NOT NULL COMMENT 'Id of the pbi dataset',
  DatasetName STRING COMMENT 'Name of the dataset',
  WorkspaceId STRING COMMENT 'Id of the associated pbi workspace',
  ...
  CONSTRAINT `DatasetId` PRIMARY KEY (`DatasetId`))
USING delta
