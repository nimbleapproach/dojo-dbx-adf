...
CREATE TABLE IF NOT EXISTS {catalog}.{schema}.link_reseller_to_reseller_group (
  link_reseller_to_reseller_group_pk BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
  ...
  CONSTRAINT `link_reseller_to_reseller_group_primary_key` PRIMARY KEY (`link_reseller_to_reseller_group_pk`))
USING delta
CLUSTER BY (link_reseller_to_reseller_group_pk)
TBLPROPERTIES (
