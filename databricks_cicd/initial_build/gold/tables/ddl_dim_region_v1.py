...
CREATE TABLE IF NOT EXISTS {catalog}.{schema}.dim_region (
  ...
  country_codee STRING COMMENT 'The country code to which the region relates',
  countrye STRING COMMENT 'The name of the country',
  country_detaile STRING COMMENT 'Context of the country potentially including the reference to entity',
  country_visualse STRING COMMENT 'Country name to be used in Power BI visualisations',
  region_groupe STRING COMMENT 'The high level region grouping',
